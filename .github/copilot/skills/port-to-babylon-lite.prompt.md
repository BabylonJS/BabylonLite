...
| `camera.attachControl(canvas, true)`                                     | `attachControl(camera, canvas)` _(arc-rotate)_ or `attachFreeControl(camera, canvas)` _(free)_ |
...
```typescript
import {} from /* only what you need */ "babylon-lite";
