/**
 * Scene 50 — RTT with per-pass material override Parity Test
 *
...
const REFERENCE_DIR = path.resolve(__dirname, "../../../reference/scene50-rtt-override");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test("Scene 50 — RTT with material override matches Babylon.js reference", async ({ page }) => {
