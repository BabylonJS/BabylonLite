/**
 * Scene 100 — RTT with per-pass material override Parity Test
 *
...
const REFERENCE_DIR = path.resolve(__dirname, "../../../reference/scene100-rtt-override");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test("Scene 100 — RTT with material override matches Babylon.js reference", async ({ page }) => {
    const browser = page.context().browser()!;
    await captureGolden(browser, { sceneId: 100 });

    await page.goto("/scene100.html");
