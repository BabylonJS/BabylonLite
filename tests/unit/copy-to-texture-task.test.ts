...
function makeMockEngine(capture: BeginPassCapture): EngineContextInternal {
    const pass = {
...
function buildColor(rt: ReturnType<typeof makeOffscreenRT>, engine: EngineContextInternal, mipLevelCount = 1): void {
