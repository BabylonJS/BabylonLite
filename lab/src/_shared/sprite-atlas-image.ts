 ...
 *  - Frames 0..7  : "spinner" — a single white wedge rotated to 8 angles on a black bg (used for animated scenes).
 ...
 * via `loadTexture2D(engine, dataUrl, …)` (Lite) or `Texture(dataUrl, scene)` (BJS).
 */
...
export const SPRITE_ATLAS_INFO = {
    ...
    columns: 8,
    rows: 4,
    spinnerClip: { name: "spin", frames: [0, 1, 2, 3, 4, 5, 6, 7], fps: 12, loop: true },
};
