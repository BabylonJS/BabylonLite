...
(async function () {
    ...
    // Exact camera values captured from playground #YG3BBF#16 (match lite scene142).
    const cam = new ArcRotateCamera("camera", Math.PI / 2, Math.PI / 2, 1.1856086997830126, new Vector3(-0.2914360649171073, 0.4, 0.3975263311541397), scene);
    cam.fov = 0.8;
    cam.minZ = 0.0697417;
    cam.maxZ = 6974.17;
