...
`158`, `170`, `200`, `201`, `202`, `203`, `204`, `205`, `207`, `210`, `213`, `216`, `218`,
`219`, `221`, `222`, `223`, `224`
...
| Navigation meshes (Recast)                                  | 171, 174, 175                                                                                         | Recast nav **is** wrapped: scene **170** works (MAD ≈ 0) via a compat `@babylonjs/addons/navigation` wrapper (`navigation/navigation.ts`) over Babylon Lite's native Recast API (`createNavigationPluginAsync` / `createNavMesh` / `createDebugNavMeshGeometry` / `createNavCrowd`); the `@recast-navigation/*` packages the oracle imports are shimmed to no-ops since Lite loads its own Recast wasm. **171/174/175** add crowd pathfinding / agent steering / obstacles not yet surfaced on the wrapper.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |     |
